...
import { Box, Button, Container, createTheme, Dialog, DialogActions, DialogContent, DialogTitle, Fab, FormControl, FormControlLabel, FormLabel, InputAdornment, Radio, RadioGroup, Stack, Table, TableBody, TableCell, TableHead, TableRow, TextField, ThemeProvider, useColorScheme } from "@mui/material";
            ...
            <ThemeProvider theme={darkTheme}>
                <Container>
                    ...
                    >
                        ...
                        <Fab
                            color="primary"
                            aria-label="add" onClick={openModal}
                            sx={{
                                alignSelf: 'flex-end',
                            }}
                        >
                ...
                >
                    ...
                    <DialogActions>
                        ...
                        <Button disabled={saving} variant="contained" color="error" onClick={closeModal}>Cancelar</Button>
                    </DialogActions>
                </Dialog>
            </ThemeProvider>
